...
// object containing different wrappers for currency
var Wrappers = {
    rupeesWrapper(tip){
...
document.getElementById("calculate").onclick = function() {
    ...
    //new object of CalculateTip class
    let tipTotal = new CalculateTip(billAmt,serviceQual,numOfPeople);
    //Display the tip but borrow properties from wrapper object #mixin
    Object.assign(tipTotal,Wrappers);
    tipTotal.dollarWrapper(tipTotal);
  };